...
!function (t) {
    ...
    return t.component("datepicker", {
        defaults: {
            ...
            if (!t.support.touch || "date" != this.element.attr("type") || this.options.mobile) {
                ...
                this.current = this.element.val() ? n(this.element.val(), this.options.format) : n(), this.on("click focus", function () {
                    a !== s && s.pick(this.value ? this.value : "")
                }).on("change", function () {
            ...
            var a = this.options, s = n().format("YYYY-MM-DD"), i = [31, t % 4 === 0 && t % 100 !== 0 || t % 400 === 0 ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e], r = new Date(t, e, 1, 12).getDay(), o = {
                month: e,
                year: t,
                weekdays: [],
                days: [],
            ...
            a.maxDate !== !1 && (o.maxDate = isNaN(a.maxDate) ? n(a.maxDate, a.format).startOf("day").hours(12) : n().add(a.maxDate, "days").startOf("day").hours(12)), a.minDate !== !1 && (o.minDate = isNaN(a.minDate) ? n(a.minDate, a.format).startOf("day").hours(12) : n().add(a.minDate - 1, "days").startOf("day").hours(12)), o.weekdays = function () {
                for (var t = 0, e = []; 7 > t; t++) {
        ...
        function oe(t, e, n) {
            ...
            return i > s && (i -= 7), s - 7 > i && (i += 7), a = De(t).add(i, "d"), {
        ...
        fn.DDDD = o(fn.DDD, 3), h(c.prototype, {
            ...
            return De.isDuration(t) ? o = {
                ms: t._milliseconds,
                d: t._days,
                M: t._months
            } : "number" == typeof t ? (o = {}, e ? o[e] = t : o.milliseconds = t) : (u = ze.exec(t)) ? (a = "-" === u[1] ? -1 : 1, o = {
                y: 0,
                d: S(u[be]) * a,
                h: S(u[Se]) * a,
                m: S(u[Te]) * a,
                s: S(u[Oe]) * a,
                ms: S(u[We]) * a
            }) : (u = xe.exec(t)) ? (a = "-" === u[1] ? -1 : 1, i = function (t) {
                ...
                s: i(u[7]),
                w: i(u[8])
            }) : "object" == typeof o && ("from" in o || "to" in o) && (r = y(De(o.from), De(o.to)), o = {}, o.ms = r.milliseconds, o.M = r.months), s = new l(o), De.isDuration(t) && n(t, "_locale") && (s._locale = t._locale), s
