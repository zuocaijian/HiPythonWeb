        ...
        function r(t, n) {
            ...
            if (n.before(n, t) !== !1) {
                ...
                a.upload.addEventListener("progress", function (e) {
                    ...
                    n.abort(e)
                }, !1), a.open(n.method, n.action, !0), "json" == n.type && a.setRequestHeader("Accept", "application/json");
                for (var s in n.headers)a.setRequestHeader(s, n.headers[s]);
    ...
    return e.component("uploadSelect", {
        ...
        defaults: {dragoverClass: "uk-dragover"}, init: function () {
            ...
            this.on("drop", function (n) {
                n.originalEvent.dataTransfer && n.originalEvent.dataTransfer.files && (n.stopPropagation(), n.preventDefault(), e.element.removeClass(e.options.dragoverClass), e.element.trigger("dropped.uk.upload", [n.originalEvent.dataTransfer.files]), t(n.originalEvent.dataTransfer.files, e.options))
